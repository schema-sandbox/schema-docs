  ...
  return [
    ...
    },
    {
      ...
      ok: Boolean(
        ...
        && sizeCheckCli.includes("totalBytes: 2_847_010")
        && sizeCheckCli.includes("totalLines: 59_191")
        && sizeCheckCli.includes("largestFileBytes: 131_682")
        && sizeCheckCli.includes("runtimeLargestFileBytes: 126_414")
    ...
    },
    {
      ...
      ok: Boolean(
        ...
        && releaseArtifactsCli.includes("schema-docs_0.1.4_x64_en-US.msi")
        && releaseArtifactsCli.includes("schema-docs_0.1.4_x64-setup.exe")
    ...
    },
    {
      ...
      ok: Boolean(
        ...
        && desktopVerificationTemplate?.releaseTarget === "v0.1.4"
