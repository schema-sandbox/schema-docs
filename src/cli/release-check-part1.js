  ...
  return [
    ...
    },
    {
      ...
      ok: Boolean(
        ...
        && readmeDoc.includes("# Schema Docs (v0.1.0)")
    ...
    },
    {
      ...
      ok: Boolean(
        ...
        && releaseArtifactsCli.includes("schema-docs_0.1.0_x64_en-US.msi")
        && releaseArtifactsCli.includes("schema-docs_0.1.0_x64-setup.exe")
    ...
    },
    {
      ...
      ok: Boolean(
        ...
        && desktopVerificationTemplate?.releaseTarget === "v0.1.0"
