  ...
  return [
    ...
    },
    {
      ...
      ok: Boolean(
        ...
        && sizeCheckCli.includes("totalBytes: 2_823_345")
        && sizeCheckCli.includes("totalLines: 58_992")
        && sizeCheckCli.includes("largestFileBytes: 123_656")
        && sizeCheckCli.includes("runtimeLargestFileBytes: 123_656")
