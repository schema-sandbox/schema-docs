  ...
  return [
    ...
    },
    {
      ...
      ok: Boolean(
        ...
        && sizeCheckCli.includes("totalBytes: 2_836_650")
        && sizeCheckCli.includes("totalLines: 59_114")
        && sizeCheckCli.includes("largestFileBytes: 126_267")
        && sizeCheckCli.includes("runtimeLargestFileBytes: 126_267")
