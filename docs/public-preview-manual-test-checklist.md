# Public Preview Manual Verification Checklist (v0.1.3)
...
> [!IMPORTANT]
> **Primary Target Platform**: Windows is the prioritized target for the v0.1.3 public preview. Verification on other operating systems is not promised or officially supported for this release.
...
* **Steps**:
  1. Double-click `schema-docs_0.1.3_x64-setup.exe`.
...
* **Action**: Run the installer (`schema-docs_0.1.3_x64-setup.exe`) and launch the application from the desktop shortcut.
